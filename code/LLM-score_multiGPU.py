...
parser.add_argument('--model', default="meta-llama/Meta-Llama-3-70B", help='Model name: e.g. tartuNLP/Llammas-base, tartuNLP/Llammas-translate, meta-llama/Meta-Llama-3-70B etc.', type=str,  required=False)  
